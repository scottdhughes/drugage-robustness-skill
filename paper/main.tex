...
\begin{tabular}{lrrrr}
\toprule
Ranking & $\tau$ vs.\ $R$ & ITP-pos top-Q & ITP-neg top-Q & Holdout AUROC \\
\midrule
Median effect & 0.570 & 1 & 0 & 0.771 \\
Trimmed mean & 0.563 & 1 & 0 & 0.792 \\
Experiment count & 0.136 & 7 & 6 & 0.833 \\
Species $\times$ sign consistency & --- & 8 & 2 & 0.708 \\
Robustness $R$ & 1.000 & 8 & 3 & \textbf{0.847} \\
\bottomrule
\end{tabular}
\caption{ITP concordance and holdout AUROC under five rankings. The species $\times$ sign-consistency baseline (the simplest comparator matching the ranking's dominant lever) recovers ITP-positive compounds but has lower discriminative power (AUROC 0.708 vs.\ 0.847).}
\label{tab:baselines}
\end{table}
...
\textbf{Cross-database check.} Of 215 Geroprotectors.org compounds, 176 (81.9\%) matched DrugAge by name --- substantially higher than the 20.7\% expected if Geroprotectors drew randomly from DrugAge's 1{,}038 compounds, confirming shared curation of well-studied longevity interventions. Among matches: 22 robust, 27 promising, 94 thin evidence, 33 conflicted.
